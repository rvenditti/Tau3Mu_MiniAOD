...
config = config()
config.General.requestName = 'SkimTau3Mu_BParking_Run2018B_BPH4_Mini_lumi4_v5'
...
config.Data.outputDatasetTag = 'SkimTau3Mu_BParking_Run2018B_BPH4_Mini_lumi4_v5'
