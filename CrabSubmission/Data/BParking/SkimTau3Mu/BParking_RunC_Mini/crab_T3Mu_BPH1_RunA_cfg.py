...
config.General.requestName = 'SkimTau3Mu_BParking_Run2018C_BPH1_Mini_v5'
...
config.Data.inputDataset = '/ParkingBPH1/Run2018C-05May2019-v1/MINIAOD'
...
config.Data.outputDatasetTag = 'SkimTau3Mu_BParking_Run2018C_BPH1_Mini_v5'
config.JobType.allowUndistributedCMSSW = True 
config.Site.storageSite = 'T2_IT_Bari'
#config.Site.ignoreGlobalBlacklist  = False
#config.Data.lumiMask = 'crab_projects/crab_SkimTau3Mu_BParking_Run2018C_BPH1_Mini_v4/results/lumisToProcess.json'
