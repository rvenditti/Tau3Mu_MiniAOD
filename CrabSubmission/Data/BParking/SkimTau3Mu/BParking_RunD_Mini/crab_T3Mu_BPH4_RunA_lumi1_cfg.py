...
config = config()
config.General.requestName = 'SkimTau3Mu_BParking_Run2018D_BPH4_Mini_lumi1_v5'
...
config.Data.outputDatasetTag = 'SkimTau3Mu_BParking_Run2018D_BPH4_Mini_lumi1_v5'
