...
config = config()
config.General.requestName = 'SkimTau3Mu_BParking_Run2018D_BPH4_Mini_lumi3_v5'
...
config.Data.outputDatasetTag = 'SkimTau3Mu_BParking_Run2018D_BPH4_Mini_lumi3_v5'
